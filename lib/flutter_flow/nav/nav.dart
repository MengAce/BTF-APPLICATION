...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, state) =>
          appStateNotifier.loggedIn ? const TimerWidget() : const HomePageWidget(),
      routes: [
        FFRoute(
          name: '_initialize',
          path: '/',
        ...
        FFRoute(
          name: 'HowtoUse',
          path: '/howtoUse',
          builder: (context, params) => const HowtoUseWidget(),
        ),
        FFRoute(
          name: 'ReportHistory',
          path: '/reportHistory',
        ...
        FFRoute(
          name: 'UploadCamera',
          path: '/uploadCamera',
          builder: (context, params) => const UploadCameraWidget(),
        ),
        FFRoute(
          name: 'Terms',
          path: '/terms',
        ...
        FFRoute(
          name: 'lol',
          path: '/lol',
          builder: (context, params) => const LolWidget(),
        )
