...
import 'schema/campsite_record.dart';
...
export 'schema/campsite_record.dart';
...
/// Functions to query CampsiteRecords (as a Stream and as a Future).
Future<int> queryCampsiteRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      CampsiteRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<CampsiteRecord>> queryCampsiteRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      CampsiteRecord.collection,
      CampsiteRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<CampsiteRecord>> queryCampsiteRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
