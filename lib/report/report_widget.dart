  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<UsersRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<UsersRecord> reportUsersRecordList = snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final reportUsersRecord = reportUsersRecordList.isNotEmpty
            ? reportUsersRecordList.first
            : null;
                        ...
                        onPressed: () async {
                          await ReportRecord.collection
                              ...
                              .set(createReportRecordData(
                                ...
                                image: reportUsersRecord?.postPhoto,
